...
public class Common {
    ...
    public static ACLMessage getACLMessage(int performative, AID[] receivers, String content) {
    ...
    public static String getLocalNames(AID[] aids) {
    ...
    public static int evaluate(String good) {
        return good.length() * 1000;
    }

    public static void print(Agent agent, ACLMessage msg) {
        print(agent, "msg: " + msg.getSender().getLocalName() + " | " + ACLMessage.getPerformative(msg.getPerformative()) + " | " + msg.getContent());
    }

    public static void print(Agent agent, String s) {
