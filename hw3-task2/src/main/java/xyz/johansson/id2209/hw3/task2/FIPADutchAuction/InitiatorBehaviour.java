...
public class InitiatorBehaviour extends FSMBehaviour {
    ...
    public static final int DECREMENT_PERIOD = 100;
    ...
    public InitiatorBehaviour(Agent agent, String good, String museum) {
        this.agent = agent;
        this.good = good;
        this.museum = museum;
    ...
    private class S0Behaviour extends WakerBehaviour {
        ...
        protected void onWake() {
            participants = Common.getService(agent, "participant " + museum);
